...
namespace Labb1_MVC_Razor.Models
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Book>().HasData(new Book { BookId = 1, Title = "The Hobbit", 
            ...
            modelBuilder.Entity<Book>().HasData(new Book { BookId = 2, Title = "Fellowship of the Ring", 
                ...
                "in The Two Towers and The Return of the King.", Amount = 5 });
            modelBuilder.Entity<Book>().HasData(new Book { BookId = 3, Title = "Two Towers", 
                ...
                "which reaches its awesome climax in The Return of the King.\r\nKundrecensioner", Amount = 10 });
            modelBuilder.Entity<Book>().HasData(new Book{BookId = 4, Title = "Return of the King",
                ...
                Amount = 7});
            modelBuilder.Entity<Book>().HasData(new Book { BookId = 5, Title = "The Lord of the Rings Boxed Set",
